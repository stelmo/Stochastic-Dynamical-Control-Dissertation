...
1\times 10^{-4} & 0\\0 & 10
\end{pmatrix}$ with everything else the same. The state space representation is shown in Figure \ref{fig_kfphase2}. 
\begin{figure}[H] 
\centering
