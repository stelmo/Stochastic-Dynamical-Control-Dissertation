...
\begin{tikzpicture}
  ...
  % Define nodes
  \node[obs] (ya) {$y_{t-2}$};
  \node[obs, right=of ya] (yb) {$y_{t-1}$};
  \node[obs, right=of yb] (yc) {$y_t$};
  \node[latent, above=of ya]  (xa) {$x_{t-2}$};
  \node[latent, above=of yb, right=of xa]  (xb) {$x_{t-1}$};
  \node[latent, above=of yc, right=of xb]  (xc) {$x_t$};
  \node[det, above=of xa] (da) {$u_{t-2}$};
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.25]{kalman_filter_timeseries_M1.pdf}
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.25]{kalman_filter_phase_M1.pdf}
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.25]{kalman_filter_timeseries_M2.pdf}
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.25]{kalman_filter_phase_M2.pdf}
