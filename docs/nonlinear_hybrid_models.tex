...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.3]{pf_m2_compspf.pdf}
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.3]{spf_m2_track.pdf}
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.3]{spf_m2_switch.pdf}
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.3]{spf_m2_switchmax.pdf}
