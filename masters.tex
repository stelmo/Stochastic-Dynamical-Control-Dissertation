...
%\includeonly{./docs/lit_back,./docs/linear_models,./docs/nonlinear_models,./docs/linear_control}
...
%\includeonly{./docs/lit_back,./docs/hmm}
...
\include{./docs/switching_linear_control}
